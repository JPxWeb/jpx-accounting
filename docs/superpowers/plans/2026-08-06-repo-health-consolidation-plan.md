...
> **STATUS (2026-08-06):** Waves **0 + A–C COMPLETE** on `main` (PR #35). Do not re-execute A–C items. **Still active:** Waves D–G and residual P1/P2 items not closed by A–C (notably P0-4, P1-1, P1-4, P1-7, P1-11 docs remainder, P1-20). Wave B/C execution plans archived under [`../../archive/superpowers/plans/`](../../archive/superpowers/plans/). Post–Wave C option-space: improvement brainstorm when present under `docs/superpowers/plans/`.
>
