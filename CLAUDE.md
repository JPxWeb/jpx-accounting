...
- **Track A future-work plans** live under [`docs/superpowers/plans/`](docs/superpowers/plans/) (Phase 5 Capture, Phase 6 Advisor, Phase 7 Reports, Phase 8 Settings depth, unified radius, IA restructure). PR-D2/D3 (#26, #27) landed the IA scaffolding + settings layout; the listed plans capture what remains.
